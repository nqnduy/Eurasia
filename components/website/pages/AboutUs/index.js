					...
					<GridLayout>
						<div className="AboutUs__firstSection">
							<MainTextWrap className="AboutUs__firstSection-text" title="About us" typeTitle="main" isLarge={true}>
								<p>
									It takes fine taste and exceptional passion to bring Western aesthetic into the cradle of Asian culture. That is how Eurasia Concept
									is conceived, with a mission to open myriad of doors for the crème de la crème of European interior design to enter Vietnam’s elite
							...
							<div className="AboutUs__secondSection-text">
								<MainTextWrap title="EXPERIENCE" typeTitle="main" isLarge={true}>
									<p>
										...
										imported from Europe at the retail podium of the iconic Times Square building in downtown Saigon. Our collection carries a wide
										range of exquisite items from leading brands.
									</p>
